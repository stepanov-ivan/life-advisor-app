...
final class LLMContractTests: XCTestCase {
    ...
    func testIngredientBreakdownWithinTolerancePasses() throws {
        let json = """
        {
          ...
          \"confidence\": \"medium\",
          \"items\": [
            {\"name\": \"Биг Мак\", \"estimatedCalories\": 500, \"estimatedProteins\": 20, \"estimatedFats\": 18, \"estimatedCarbs\": 45, \"impact_score\": 0.8, \"reason\": \"ok\", \"high_calorie_flag\": true},
            {\"name\": \"Штрудель\", \"estimatedCalories\": 100, \"estimatedProteins\": 4, \"estimatedFats\": 4, \"estimatedCarbs\": 10, \"impact_score\": 0.4, \"reason\": \"ok\", \"high_calorie_flag\": false}
          ],
          \"modelId\": \"model-x\",
          \"promptVersion\": \"v1\",
          \"estimationSchemaVersion\": \"v1\"
